...
using Connector.ExternalIntegrations.v1;
using Connector.ImageClassification.v1;
using Connector.OCR.v1;
using ESR.Hosting;
...
public class ConnectorRegistration : IConnectorRegistration<ConnectorRegistrationConfig>, IConfigureConnectorApiClient
{
    ...
    {
        serviceCollection.AddSingleton<IConnectorServiceDefinition, OCRV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, OCRV1CacheWriterServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, ImageClassificationV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, ImageClassificationV1CacheWriterServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, ExternalIntegrationsV1ActionProcessorServiceDefinition>();
        serviceCollection.AddSingleton<IConnectorServiceDefinition, ExternalIntegrationsV1CacheWriterServiceDefinition>();
    }
