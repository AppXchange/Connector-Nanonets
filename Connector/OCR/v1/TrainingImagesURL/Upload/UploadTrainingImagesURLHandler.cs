...
public class UploadTrainingImagesURLHandler : IActionHandler<UploadTrainingImagesURLAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UploadTrainingImagesURLActionOutput>();
            // response = await _apiClient.PostTrainingImagesURLDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetTrainingImagesURLDataObject(response.Data.id, cancellationToken);

            // var resource = new UploadTrainingImagesURLActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(TrainingImagesURLDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UploadTrainingImagesURLHandler" };
