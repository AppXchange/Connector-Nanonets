...
/// are intended to be.
/// </summary>
[Description("Action for submitting image files for synchronous prediction in the Nanonets OCR API")]
public class PredictionImageFileAction : IStandardAction<PredictionImageFileActionInput, PredictionImageFileActionOutput>
{
    public PredictionImageFileActionInput ActionInput { get; set; } = new() { File = string.Empty };
    public PredictionImageFileActionOutput ActionOutput { get; set; } = new();
    public StandardActionFailure ActionFailure { get; set; } = new();

    public bool CreateRtap => true;
}

public class PredictionImageFileActionInput
{
    ...
    [JsonPropertyName("pages_to_process")]
    [Description("Comma-separated page numbers to process")]
    public string? PagesToProcess { get; set; }
}

public class PredictionImageFileActionOutput
{
