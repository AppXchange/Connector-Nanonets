...
/// are intended to be.
/// </summary>
[Description("Action for submitting image URLs for synchronous prediction in the Nanonets OCR API")]
public class PredictionImageURLAction : IStandardAction<PredictionImageURLActionInput, PredictionImageURLActionOutput>
{
    public PredictionImageURLActionInput ActionInput { get; set; } = new() { Urls = new List<string>() };
    public PredictionImageURLActionOutput ActionOutput { get; set; } = new();
    public StandardActionFailure ActionFailure { get; set; } = new();

    public bool CreateRtap => true;
}

public class PredictionImageURLActionInput
{
...
public class PredictionImageURLActionOutput
{
