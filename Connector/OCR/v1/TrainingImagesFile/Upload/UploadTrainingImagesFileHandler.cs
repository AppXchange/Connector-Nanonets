...
public class UploadTrainingImagesFileHandler : IActionHandler<UploadTrainingImagesFileAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UploadTrainingImagesFileActionOutput>();
            // response = await _apiClient.PostTrainingImagesFileDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetTrainingImagesFileDataObject(response.Data.id, cancellationToken);

            // var resource = new UploadTrainingImagesFileActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(TrainingImagesFileDataObject), CacheChanges = operations.ToArray() }
            };
